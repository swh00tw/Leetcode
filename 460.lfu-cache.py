...
#ref: https://leetcode.com/problems/lfu-cache/solutions/3111521/o-1-time-full-explanation-hashtable-c-java-python3/
...
class LFUCache:
    ...
    def __init__(self, capacity: int):
        ...
        self.minFreq = 0
        self.keyToNode = dict()
        self.freqToList = defaultdict(deque) # use double-ended queue, queue of keys
        self.freqToKey = defaultdict(set) # set of keys
    ...
    # update freqToList, freqToKey, minFreq
    def touch(self, node):
        prevFreq = node.freq
        newFreq = node.freq + 1
